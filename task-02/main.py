...
def generator_numbers(text: str) -> Generator:
    ...
    """
    pattern = r'\s\d+\.\d+\s' #складаємо паттерн для отримання дійсних чисел з тексту
...
text = "22.34 Загальний дохід працівника складається з декількох частин: 1000.01 як основний дохід, доповнений додатковими надходженнями 27.45 і 324.00 доларів 33.23."
